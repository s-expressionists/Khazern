...
(deftest loop.4.4
  (khazern:loop for e on '(a b c d e)
        for (x . y) = e
        collect x)
  (a b c d e))

(deftest loop.4.5
  (khazern:loop for (x . y) = '(a b c d e) then y
        while x
        collect x)
  (a b c d e))
...
;; (deftest loop.4.6
;;   (signals-error
;;    (khazern:loop for (x . x) = '(nil nil nil)
;;          until x count t)
;;    program-error)
;;   t)
...
;; (deftest loop.4.7
;;   (signals-error
;;    (macroexpand '(khazern:loop for (x . x) = '(nil nil nil)
;;                        until x count t))
;;    program-error)
;;   t)
...
;; (deftest loop.4.8
;;   (signals-error
;;    (macroexpand '(khazern:loop for x = '(nil nil nil)
